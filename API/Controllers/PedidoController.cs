...
namespace ABrechozeiraApp.Controllers
{
    ...
    public class PedidoController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeletePedido(int id)
        {
            ...
            // Exclui os itens associados a este pedido primeiro para evitar erro de FK
            var linkedProdutos = await _context.PedidoProduto.Where(pp => pp.PedidoId == id).ToListAsync();
            if (linkedProdutos.Any())
            {
                _context.PedidoProduto.RemoveRange(linkedProdutos);
            }
