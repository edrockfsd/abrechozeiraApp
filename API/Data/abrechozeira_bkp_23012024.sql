...
-- Copiando dados para a tabela abrechozeira.Venda: ~3 rows (aproximadamente)
INSERT IGNORE INTO `Venda` (`Id`, `Quantidade`, `PrecoVenda`, `Desconto`, `ClienteId`, `ProdutoId`, `CodigoLive`, `OrigemID`) VALUES
	(2, 1, 80.000000000000000000000000000000, NULL, 4, 3, 189, 1),
	(3, 1, 300.000000000000000000000000000000, NULL, 4, 4, 356, 1),
	(4, 1, 289.900000000000000000000000000000, NULL, 4, 7, 85, 1);
