...
export class CadastroPessoaComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.pessoaForm.valid && !this.salvando) {
      ...
      const pessoa = {
        ...
        telefone: this.pessoaForm.value.telefone ? this.pessoaForm.value.telefone.replace(/\D/g, '') : '',
        cpf: this.pessoaForm.value.cpf || null,
        rg: this.pessoaForm.value.rg || null,
        email: this.pessoaForm.value.email || null,
        ...
        nickName: this.pessoaForm.value.nickName || null
      };
  ...
  formatarTelefone(): void {
    let value = this.pessoaForm.get('telefone')?.value;
    if (!value) return;
